//package com.cooksys.socialmediaassignment.team2;
//
...
//        tweet1.setTagList(Arrays.asList(hashtag1, hashtag2));
//        tweet1.setMentionList(Arrays.asList(user1, user2));
...
//        tweet2.setTagList(Arrays.asList(hashtag1, hashtag2));
...
//        tweet3.setTagList(Arrays.asList(hashtag3, hashtag4));
...
//        tweet5.setMentionList(Arrays.asList(user1, user2));
...
//        tweet6.setMentionList(Arrays.asList(user1, user2));
...
//        deletedTweet.setMentionList(Arrays.asList(user1, user2));
//        tweetRepository.saveAndFlush(deletedTweet);
//
//        // ----- LIST of Tweets + Adding to User# -----
//        List<Tweet> user1Tweets = List.of(tweet1, tweet2);
//        user1.setTweetList(user1Tweets);
//        userRepository.saveAndFlush(user1);
//
//        List<Tweet> user2Tweets = List.of(tweet3, tweet4);
//        user2.setTweetList(user2Tweets);
//        userRepository.saveAndFlush(user2);
//
//        List<Tweet> user3Tweets = List.of(tweet5, tweet6);
//        user3.setTweetList(user3Tweets);
//        userRepository.saveAndFlush(user3);
//
//        // ----- List of Liked Tweets -----
//        user1.setTweetLikeList(user3Tweets);
//        userRepository.saveAndFlush(user1);
//
//        user2.setTweetLikeList(user1Tweets);
//        user2.setTweetLikeList(user2Tweets);
//        userRepository.saveAndFlush(user2);
//
//        user3.setTweetLikeList(user2Tweets);
//        userRepository.saveAndFlush(user3);
//
//        deletedUser.setTweetLikeList(user2Tweets);
//        userRepository.saveAndFlush(deletedUser);
//
////        // ----- List of Following -----
////        List<User> followingList = List.of(user2, user3, user4);
////        user1.setFollowingList(followingList);
////        userRepository.saveAndFlush(user1);
////        // ----- List of Followers -----
////        List<User> followersList = List.of(user3, user5);
////        user1.setFollowerList(followersList);
////        userRepository.saveAndFlush(user1);
//
//        // ----- Tweet Mentions -----
...
//        user1.setFollowingList(following_1);
//
//        List<User> followers_1 = List.of(user5, deletedUser);
//        user1.setFollowerList(followers_1);
//        userRepository.saveAndFlush(user1);
//    }
//
//}